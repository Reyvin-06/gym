...
namespace Gym {
    ...
    public partial class gymDataSet : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clientesRow AddclientesRow(int id_cliente, string nombre, int edad, string celular, string correo) {
...
namespace Gym.gymDataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clientes] ([id_cliente], [nombre], [edad], [celular], [correo]" +
                ") VALUES (@id_cliente, @nombre, @edad, @celular, @correo);\r\nSELECT id_cliente, n" +
                "ombre, edad, celular, correo FROM clientes WHERE (id_cliente = @id_cliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [id_cliente] = @id_cliente, [nombre] = @nombre, [edad] = @edad, [celular] = @celular, [correo] = @correo WHERE (([id_cliente] = @Original_id_cliente) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)) AND ((@IsNull_correo = 1 AND [correo] IS NULL) OR ([correo] = @Original_correo)));
SELECT id_cliente, nombre, edad, celular, correo FROM clientes WHERE (id_cliente = @id_cliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_cliente, nombre, edad, celular, correo FROM dbo.clientes";
        ...
        public virtual int Delete(int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo) {
        ...
        public virtual int Insert(int id_cliente, string nombre, global::System.Nullable<int> edad, string celular, string correo) {
        ...
        public virtual int Update(int id_cliente, string nombre, global::System.Nullable<int> edad, string celular, string correo, int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, global::System.Nullable<int> edad, string celular, string correo, int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo) {
            return this.Update(Original_id_cliente, nombre, edad, celular, correo, Original_id_cliente, Original_nombre, Original_edad, Original_celular, Original_correo);
        }
    }
