...
namespace Gym {
    ...
    public partial class gymDataSet3 : global::System.Data.DataSet {
        ...
        public partial class clientesDataTable : global::System.Data.TypedTableBase<clientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public clientesRow AddclientesRow(int id_cliente, string nombre, int edad, string celular, string correo, string estado) {
...
namespace Gym.gymDataSet3TableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[clientes] WHERE (([id_cliente] = @Original_id_cliente) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)) AND ((@IsNull_correo = 1 AND [correo] IS NULL) OR ([correo] = @Original_correo)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[clientes] ([id_cliente], [nombre], [edad], [celular], [correo], [estado]) VALUES (@id_cliente, @nombre, @edad, @celular, @correo, @estado);
SELECT id_cliente, nombre, edad, celular, correo, estado FROM clientes WHERE (id_cliente = @id_cliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[clientes] SET [id_cliente] = @id_cliente, [nombre] = @nombre, [edad] = @edad, [celular] = @celular, [correo] = @correo, [estado] = @estado WHERE (([id_cliente] = @Original_id_cliente) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_edad = 1 AND [edad] IS NULL) OR ([edad] = @Original_edad)) AND ((@IsNull_celular = 1 AND [celular] IS NULL) OR ([celular] = @Original_celular)) AND ((@IsNull_correo = 1 AND [correo] IS NULL) OR ([correo] = @Original_correo)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_estado)));
SELECT id_cliente, nombre, edad, celular, correo, estado FROM clientes WHERE (id_cliente = @id_cliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_cliente, nombre, edad, celular, correo, estado FROM dbo.clientes";
        ...
        public virtual int Fill(gymDataSet3.clientesDataTable dataTable) {
        ...
        public virtual gymDataSet3.clientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            gymDataSet3.clientesDataTable dataTable = new gymDataSet3.clientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(gymDataSet3.clientesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo, string Original_estado) {
        ...
        public virtual int Insert(int id_cliente, string nombre, global::System.Nullable<int> edad, string celular, string correo, string estado) {
        ...
        public virtual int Update(int id_cliente, string nombre, global::System.Nullable<int> edad, string celular, string correo, string estado, int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo, string Original_estado) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, global::System.Nullable<int> edad, string celular, string correo, string estado, int Original_id_cliente, string Original_nombre, global::System.Nullable<int> Original_edad, string Original_celular, string Original_correo, string Original_estado) {
            return this.Update(Original_id_cliente, nombre, edad, celular, correo, estado, Original_id_cliente, Original_nombre, Original_edad, Original_celular, Original_correo, Original_estado);
        }
    }
